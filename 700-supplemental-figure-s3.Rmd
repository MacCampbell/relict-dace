...
```{r}
files<-mixedsort(list.files("outputs/700/", pattern="admix.Q.npy", full.names = TRUE), decreasing=TRUE)
plots<-lapply(files, PlotPCAdmix)
```


```{r}
jpeg(filename = "outputs/700/Supplemental Figure S3.jpeg",width=12, height=54, units = "in", res = 300)
